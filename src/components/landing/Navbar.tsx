  ...
  sections: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: "Hospitals & Community Clinics",
          description: "Streamline referrals and flag patients who need specialist care using TEFCA/QHIN and direct EHR integration.",
        },
      ],
    },
  ],
